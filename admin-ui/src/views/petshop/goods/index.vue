<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择类型" clearable>
          <el-option
            v-for="dict in dict.type.shop_goods_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属商店" align="center" prop="shopName" />
      ...
      <el-table-column label="类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.shop_goods_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属商店" prop="shopName">
          <el-input v-model="form.shopName" placeholder="请输入所属商店" />
        </el-form-item>
        ...
        <el-form-item label="库存" prop="amount">
          <el-input v-model="form.amount" placeholder="请输入库存" />
        </el-form-item>
        <el-form-item label="类型" prop="type">
...
<script>
import { listGoods, getGoods, delGoods, addGoods, updateGoods } from "@/api/petshop/goods";

export default {
  name: "Goods",
  dicts: ['shop_goods_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
